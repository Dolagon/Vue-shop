            ...
            <section>
              ...
              <section class="login-verification">
                ...
                <div class="switch-show">
                  <img src="./images/hide_pwd.png" :class="{on: pwdMode}" @click.prevent="dealPwdMod(false)" alt="" width="20">
                  <img src="./images/show_pwd.png" :class="{on: !pwdMode}" @click.prevent="dealPwdMod(true)" alt="" width="20">
                </div>
              </section>
              <section class="login-message">
  ...
  methods: {
    ...
    async login() {
      ...
      if (this.loginMode) {  // 验证码登陆
        ...
        console.log(result);
        // result.success_code === 200 || result.error_code === 0
    ...
    getCaptcha() {
      ...
      // 设置标签的src属性
      this.$set(captchaEle, 'src', 'http://localhost:3000/web/xlmc/api/captcha?t=' + Math.random());
    }
  }
}
</script>
